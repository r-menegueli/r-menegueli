...
> **Comparativo entre Controle Escalar (V/f) e Controle Vetorial por Orientação de Campo (FOC) em Motor de Indução Trifásico Aplicado a Veículos Elétricos**
> 
> Plataforma computacional desenvolvida em **MATLAB/Simulink** para comparar sob mesmos ciclos de condução veicular e perturbações de carga a dinâmica eletromecânica, o transitório de torque, a resposta temporal e as perdas elétricas entre estratégias escalares e vetoriais acopladas a inversor VSI com modulação SVPWM.
> 
> 🔗 [Acessar repositório do TCC](https://github.com/r-menegueli/tcc-controle-motor-inducao)
...
| 💻 [**Sistema de Pedidos em C++**](https://github.com/r-menegueli/restaurante-pedidos-c) | C++17, CMake, Algoritmos & Estruturas | Gestão de pedidos orientada a objetos com persistência em arquivos, relatórios e testes de ponta a ponta. |

---

### 🛠️ Tecnologias & Ferramentas

#### Simulação & Engenharia Elétrica
![MATLAB](https://img.shields.io/badge/MATLAB-e16737?style=for-the-badge&logo=mathworks&logoColor=white)
![Simulink](https://img.shields.io/badge/Simulink-0076A8?style=for-the-badge)
![PSIM](https://img.shields.io/badge/PSIM-Simulation-blue?style=for-the-badge)
![LTspice](https://img.shields.io/badge/LTspice-Circuit%20Analysis-darkred?style=for-the-badge)
...
#### Projetos & Documentação CAD
![AutoCAD](https://img.shields.io/badge/AutoCAD-E51027?style=for-the-badge&logo=autodesk&logoColor=white)
![Microsoft Excel](https://img.shields.io/badge/Microsoft_Excel-217346?style=for-the-badge&logo=microsoft-excel&logoColor=white)

#### Computação & Controle de Versão
